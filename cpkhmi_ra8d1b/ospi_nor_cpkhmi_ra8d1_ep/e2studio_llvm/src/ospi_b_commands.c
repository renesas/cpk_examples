...
spi_flash_direct_transfer_t g_ospi_b_direct_transfer [OSPI_B_TRANSFER_MAX] =
{
 /* Transfer structure for SPI mode */
    ...
    {
    .command        = OSPI_B_COMMAND_WRITE_Non_REGISTER_SPI,
    .address        = OSPI_B_ADDRESS_change_witch_REGISTER,
    .data           = OSPI_B_DATA_change_witch_REGISTER,
    .command_length = OSPI_B_COMMAND_LENGTH_SPI,
    ...
    {
    .command        = OSPI_B_COMMAND_READ_ERASE_SPI,
    .address        = OSPI_B_ADDRESS_DUMMY,
    ...
    {
    .command        = OSPI_B_COMMAND_READ_ERASE_SPI,
    .address        = OSPI_B_ADDRESS_MODEL_REGISTER,
    .data           = OSPI_B_DATA_DUMMY,
    .command_length = OSPI_B_COMMAND_LENGTH_SPI,
    ...
    {
    .command        = OSPI_B_COMMAND_READ_Non_REGISTER_SPI,
    .address        = OSPI_B_ADDRESS_change_witch_REGISTER,
    .data           = OSPI_B_DATA_DUMMY,
    .command_length = OSPI_B_COMMAND_LENGTH_SPI,
    .address_length = OSPI_B_ADDRESS_LENGTH_THREE,
    .data_length    = OSPI_B_DATA_LENGTH_TWO,
    .dummy_cycles   = OSPI_B_DUMMY_CYCLE_READ_WITCH_SPI
    },
    [OSPI_B_TRANSFER_READ_FLAG_SPI] =
    {
    .command        = OSPI_B_COMMAND_READ_FLAG_SPI,
    .address        = OSPI_B_ADDRESS_DUMMY,
    .data           = OSPI_B_DATA_DUMMY,
    .command_length = OSPI_B_COMMAND_LENGTH_SPI,
    .address_length = OSPI_B_ADDRESS_LENGTH_ZERO,
    ...
    {
    .command        = OSPI_B_COMMAND_READ_VOLA_SPI,
    .address        = OSPI_B_ADDRESS_MODEL_REGISTER,
    .data           = OSPI_B_DATA_DUMMY,
    .command_length = OSPI_B_COMMAND_LENGTH_SPI,
    .address_length = OSPI_B_ADDRESS_LENGTH_THREE,
    ...
    {
    .command        = OSPI_B_COMMAND_READ_DATA_SPI,
    .address        = OSPI_B_ADDRESS_READ_DATA_REGISTER,
    .data           = OSPI_B_DATA_DUMMY,
    .command_length = OSPI_B_COMMAND_LENGTH_SPI,
    .address_length = OSPI_B_ADDRESS_LENGTH_FOUR,
    .data_length    = OSPI_B_DATA_LENGTH_ONE,
    ...
    .address        = OSPI_B_COMMAND_READ_ERASE_SPI,
