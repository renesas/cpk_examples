...
// #define ITCM_CODE	__attribute__((section(".itcm_data")))
// #define DTCM_DATA	__attribute__((section(".dtcm_data")))
#include "bsp_api.h"
#define ITCM_CODE	BSP_PLACE_IN_SECTION(".itcm_code_from_flash")
#define DTCM_DATA	BSP_PLACE_IN_SECTION(".dtcm_code_from_flash")
