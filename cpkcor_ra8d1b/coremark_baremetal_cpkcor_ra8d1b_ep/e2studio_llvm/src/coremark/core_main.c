...
/* Function: iterate
        ...
        NULL.
*/
DTCM_DATA static ee_u16 list_known_crc[]   = { (ee_u16)0xd4b0,
                                   (ee_u16)0x3340,
                                   (ee_u16)0x6a79,
                                   (ee_u16)0xe714,
                                   (ee_u16)0xe3c1 };
DTCM_DATA static ee_u16 matrix_known_crc[] = { (ee_u16)0xbe52,
                                     (ee_u16)0x1199,
                                     (ee_u16)0x5608,
                                     (ee_u16)0x1fd7,
                                     (ee_u16)0x0747 };
DTCM_DATA static ee_u16 state_known_crc[]  = { (ee_u16)0x5e47,
                                    (ee_u16)0x39bf,
                                    (ee_u16)0xe5a4,
                                    (ee_u16)0x8e3a,
                                    (ee_u16)0x8d84 };
...
DTCM_DATA __attribute__((used))
DTCM_DATA volatile double dfCoremarkScore = 0.0f;

#if MAIN_HAS_NOARGC
MAIN_RETURN_TYPE
ITCM_CODE coremark_main(void)
{
    int   argc = 0;
    char *argv[1];
#else
MAIN_RETURN_TYPE
ITCM_CODE coremark_main(int argc, char *argv[])
{
#endif
