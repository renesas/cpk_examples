...
#endif
#endif
#define TURN_LED_ON                               R_IOPORT_PinWrite(&g_ioport_ctrl, USER_LED, ON);

#define KIT_NAME_MACRO                            "CPK-RA8D1"
//#define KIT_PARTNUM_MACRO                         "RTK7EKA8D1S01001BE"
#define KIT_LANDING_URL                           "renesas.com/ra/cpk-ra8d1"
