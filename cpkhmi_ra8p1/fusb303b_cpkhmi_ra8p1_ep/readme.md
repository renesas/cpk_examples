...
- 该示例工程基于瑞萨FSP， 演示了在RA8P1 MCU上使用 FUSB303B 识别和控制 USB TypeC 中 Source 和 Sink 角色。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/fusb303b_cpkhmi_ra8p1_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
- 
### 支持的开发板 / 演示板：
...
[fusb303b_ra8p1_ep_read](fusb303b_cpkhmi_ra8p1_ep_read.adoc) 
