...
CPKHMI-RA8P1的硬件版本和勘误表：

* CPKHMI-RA8P1 核心板目前有 v1.2 和 v1.1 两个版本的量产版硬件，link:../cpkhmi_ra8p1/docs/00_hw_revisions.adoc[硬件版本和勘误信息链接]

image::cpkhmi_ra8p1.png[width=480]

本核心板为 CPKMINI-RA8P1 开发套件缺省使用的核心板，套件信息请参考 link:../cpkmini_ra8p1/[CPKMINI-RA8P1]。
