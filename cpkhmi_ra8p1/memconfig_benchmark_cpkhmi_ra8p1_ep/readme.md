...
- 该示例工程基于瑞萨FSP， 演示了在RA8P1 MCU上，将代码与数据放在不同内存段时对 CM85（CPU0）运行性能的影响。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/memconfig_benchmark_cpkhmi_ra8p1_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
...
- 通过 USB Type-C 线连接调试主机和 CPKHMI-RA8P1 板上的 USB 调试端口 JDBG
