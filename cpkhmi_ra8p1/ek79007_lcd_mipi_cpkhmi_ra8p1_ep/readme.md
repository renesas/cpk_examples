...
- 该示例工程演示了基于瑞萨 FSP ，在RA8P1 MCU 驱动 EK79007 屏幕显示彩条，使用 MIPI 接口。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/ek79007_lcd_mipi_cpkhmi_ra8p1_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
...
[lcd_ek79007_mipi工程使用说明](ek79007_lcd_mipi_cpkhmi_ra8p1_ep_readme.adoc)
