...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/mcu_core_migration_spi_lcd_cpknet_ra8t2_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
...
[应用代码在双核CPU之间进行迁移的说明](mcu_core_migration_spi_lcd_cpknet_ra8t2_ep_readme.adoc) 
