 ...
 * @{
 */
/** \brief 0x607B (Position range limit) data structure*/
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   INT32    i32MinLimit; /**< \brief Min position range limit*/
   INT32    i32MaxLimit; /**< \brief Max position range limit*/
} OBJ_STRUCT_PACKED_END
TOBJ607B;
...
/** \brief Object 0x60D0 (Touch probe source) data structure*/
typedef struct OBJ_STRUCT_PACKED_START {
   UINT16   u16SubIndex0; /**< \brief SubIndex 0*/
   UINT16   u16TouchProbe1Source; /**< \brief Touch Probe 1 Source*/
} OBJ_STRUCT_PACKED_END
TOBJ60D0;
/** @}*/
...
typedef struct STRUCT_PACKED_START
{
    ...
    INT32 ObjTouchProbePos1NegValue;/**< \brief Touch probe position 1 negative value (0x60BB)*/
...
typedef struct OBJ_STRUCT_PACKED_START
{
    ...
    UINT32 objFollowingErrorTimeOut; /**< \brief Following error time out (0x6066)*/
    ...
    INT32 objTargetPosition; /**< \brief Target Position (0x607A)*/
    TOBJ607B objPositionRangeLimit; /**< \brief Position range limit (0x607B)*/
    ...
    TOBJ60D0 objTouchProbeSource; /**< \brief Touch probe source (0x60D0)*/
    UINT16 objPositiveTorqueLimitValue; /**< \brief Positive Torque Limit Value (0x60E0)*/
    UINT16 objNegativeTorqueLimitValue; /**< \brief Negative Torque Limit Value (0x60E1)*/
    INT32 objFollowingErrorActualValue;/**< \brief Following Error Actual Value (0x60F4)*/
    UINT32 objDigitalInputs;/**< \brief Digital inputs (0x60FD)*/
...
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x6066 = {DEFTYPE_UNSIGNED32, 0x10, (ACCESS_READWRITE)};
...
/**
 * \brief Object 0x607B (Position range limit) entry description
 *
 * Subindex 0<br>
...
/** \brief Object 0x607B (Position range limit) object and entry names*/
OBJCONST UCHAR OBJMEM aName0x607B[] = "Position range limit\000Min position range limit\000Max position range limit\000\377";
...
OBJCONST UCHAR OBJMEM aName0x60BA[] = "Touch probe position 1 positive value";

/**< \brief Object 0x60BB (Touch Probe Function) entry description*/
OBJCONST TSDOINFOENTRYDESC    OBJMEM sEntryDesc0x60BB = {DEFTYPE_INTEGER32, 0x20, (ACCESS_READ|OBJACCESS_TXPDOMAPPING)};
/**< \brief Object 0x60BB (Touch Probe Function) object name*/
OBJCONST UCHAR OBJMEM aName0x60BB[] = "Touch probe position 1 negative value";
...
/**
 * \brief Object 0x60D0 (Touch probe source) entry description
 *
 * Subindex 0<br>
 * Subindex 1 : Touch probe 1 source<br>
 */
OBJCONST TSDOINFOENTRYDESC    OBJMEM asEntryDesc0x60D0[] = {
    {DEFTYPE_UNSIGNED8, 0x08, ACCESS_READ},
    {DEFTYPE_INTEGER16, 0x10, ACCESS_READWRITE}};

/** \brief Object 0x60D0 (Touch probe source) object and entry names*/
OBJCONST UCHAR OBJMEM aName0x60D0[] = "Touch probe source\000Touch probe 1 source\000\377";
...
OBJCONST UCHAR OBJMEM aName0x60FE[] = "Digital Outputs\000Target Velocity\000Error register\000\377";
/** @}*/
...
#ifdef _CiA402_
= {
{12, {0x60400010,0x60720010,0x607A0020,0x60B00020,0x60B10020,0x60B20010,0x60B80010,0x60E00010,0x60E10010,0x60FE0020,0x60FF0020,0x60600010}},    /* TOBJ1600*/
...
{11, {0x603F0010,0x60410010,0x60640020,0x606C0020,0x60770010,0x60B90010,0x60BA0020,0x60BB0020,0x60F40020,0x60FD0020,0x60610010}}, /*TOBJ1A00*/
{10, {0x603F0010,0x60410010,0x60640020,0x606C0020,0x60770010,0x60B90010,0x60BA0020,0x60BB0020,0x60F40020,0x60FD0020}}, /*TOBJ1A01*/
{9, {0x603F0010,0x60410010,0x60640020,0x606C0020,0x60770010,0x60B90010,0x60BA0020,0x60BB0020,0x60FD0020}},/*TOBJ1A02*/
...
0x0,/*(INT32) Following error time out 0x6066*/
...
{2,0x88CA6C00,0x77359400},/*TOBJ607B Position range limit (minLimit: -2000000000 / maxLimit: 2000000000)*/
...
0x0,/*(INT32) Touch Probe Pos 1 Neg Value 0x60BB*/
{2,1,-3},/*TOBJ60C2 Interpolation Time Period*/
{1,0x0},/*TOBJ60D0 Touch probe source*/
...
= {
   ...
   /* Object 0x6066 */
   {NULL,NULL, 0x6066, {DEFTYPE_UNSIGNED16 , 0 | (OBJCODE_VAR << 8)}, &sEntryDesc0x6066, aName0x6066, NULL, NULL, NULL, 0x0000 },
   /* Object 0x6067 */
   ...
   /* Object 0x607B */
   {NULL,NULL, 0x607B, {DEFTYPE_RECORD , 2 | (OBJCODE_REC << 8)}, asEntryDesc0x607B, aName0x607B, NULL, NULL, NULL, 0x0000 },
   /* Object 0x607C */
   {NULL,NULL, 0x607C, {DEFTYPE_INTEGER32 , 0 | (OBJCODE_VAR << 8)}, &sEntryDesc0x607C, aName0x607C, NULL, NULL, NULL, 0x0000 },
   /* Object 0x607D */
   {NULL,NULL, 0x607D, {DEFTYPE_RECORD , 2 | (OBJCODE_REC << 8)}, asEntryDesc0x607D, aName0x607D, NULL, NULL, NULL, 0x0000 },
   /* Object 0x607A */
   ...
   /* Object 0x6091 */
   {NULL,NULL, 0x6091, {DEFTYPE_RECORD , 2 | (OBJCODE_REC << 8)}, asEntryDesc0x6091, aName0x6091, NULL, NULL, NULL, 0x0000 },
   /* Object 0x6099 */
   ...
   /* Object 0x60D0 */
   {NULL,NULL, 0x60D0, {DEFTYPE_RECORD , 1 | (OBJCODE_REC << 8)}, asEntryDesc0x60D0, aName0x60D0, NULL, NULL, NULL, 0x0000 },
   /* Object 0x60E0*/
   ...
   /* Object 0x6402 */
   {NULL,NULL, 0x6402, {DEFTYPE_UNSIGNED16 , 0 | (OBJCODE_VAR << 8)}, &sEntryDesc0x6402, aName0x6402, NULL, NULL, NULL, 0x0000 },
   /* Object 0x6502 */
