 ...
 */
#include <rpmsg-lite/include/platform/ra8t2_m33/rpmsg_config.h>
#include <rpmsg-lite/include/platform/ra8t2_m33/rpmsg_platform.h>
#include <stdio.h>
#include <string.h>
...
int32_t platform_init_interrupt(uint32_t vector_id, void *isr_data)
{
    if (platform_lock != ((void *)0))
    {
        ...
        if (isr_counter == 0)
        {
            NVIC_SetPriority(IPC_IRQ1_IRQn, 10);
        }
        isr_counter++;
...
//    if (in_isr)
//    {
//        data_receive_flag01 = 1;
//    }
//    else
//    {
//        data_receive_flag01 = 0;
//    }
//}
