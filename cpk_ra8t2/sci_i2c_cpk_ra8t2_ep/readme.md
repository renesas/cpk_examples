**该示例工程由 瑞萨电子-冉庆领 提供，2026年7月7日**

### 工程概述

- 该示例工程演示了基于瑞萨FSP的瑞萨RA MCU上 SCI-I2C 驱动程序的基本功能。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/sci_i2c_cpk_ra8t2_ep_rafsp6.5.0.zip)，其中包含了文档和代码。
...
- 采用杜邦线连接J604:1--CN4:25和J604:2--CN4:24
  - SCI0:SCL0=P602[J604:1], SDA0=P603[J604:2]
  - I2C2: SCL2=P515[CN4:25], SDA2=P514[CN4:24]
...
[sci_i2c_cpk_ra8t2_ep_readme](sci_i2c_cpk_ra8t2_ep_readme.md)
