...
#define ST7796U_PIN_BACKLIGHT	BSP_IO_PORT_13_PIN_05
#endif
...
/**
 * @brief	Set backlight
 * @note	AW9364 didn't connect to MCU on this board, so this function is useless.
 ...
 * @param	bl     Range 0-16
 * @retval	Always return FSP_ERR_UNSUPPORTED
 */
