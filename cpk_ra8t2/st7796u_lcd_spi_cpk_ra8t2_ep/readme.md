...
- 该示例工程演示了基于瑞萨 FSP ，在 RA8T2 MCU 上使用SPI接口驱动 ST7796U 屏幕显示彩条。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/st7796u_lcd_spi_cpk_ra8t2_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
...
[lcd_st7796u_spi工程使用说明](st7796u_lcd_spi_cpk_ra8t2_ep_readme.adoc)
