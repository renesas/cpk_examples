...
static const uint32_t g_sample_prv_dip_sws[] =
{
    (uint32_t) BSP_IO_PORT_03_PIN_15,  // J103 1-2     P315
    (uint32_t) BSP_IO_PORT_11_PIN_10,  // J103 3-4     PB10
    (uint32_t) BSP_IO_PORT_09_PIN_11,  // J103 5-6     P911
};

/** Array of LED IOPORT pins. */
static const uint32_t g_sample_prv_leds[] =
{
    (uint32_t) BSP_IO_PORT_04_PIN_13,   ///< LED400    P413
    (uint32_t) BSP_IO_PORT_04_PIN_12,   ///< LED401    P412
    (uint32_t) BSP_IO_PORT_09_PIN_15,   ///< LED402    P915
};
