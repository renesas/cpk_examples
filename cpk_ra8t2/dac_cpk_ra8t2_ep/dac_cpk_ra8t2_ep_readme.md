## 1.参考例程概述
该示例项目演示了基于瑞萨 FSP 的瑞萨 RA MCU 上DAC 驱动程序的基本功能。

DAC通道1输出数据，并用ADC采样获取DAC的输出值，输出log显示。

### 1.1 创建新工程
如需了解工程的详细创建及配置流程，请参考工程：perf_counter_cpknet_ra8t2_ep
### 1.2 添加DAC外设：Stack中添加“Analog - DAC（r_dac_b）”.
![alt text](images/dac0.png)
#### 1.2.1 r_dac_b 属性配置.
![alt text](images/dac1.png)
#### 1.2.2 r_dac_b 引脚配置.
![alt text](images/dac_pin.png)

### 1.3 添加ADC外设：Stack中添加“Analog - ADC（r_adc_b）”.
![alt text](images/adc0.png)
#### 1.3.1 r_dac_b 配置：请查询工程FSP详细配置.
