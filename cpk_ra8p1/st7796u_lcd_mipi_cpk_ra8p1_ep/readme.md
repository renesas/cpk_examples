...
- 该示例工程演示了基于瑞萨 FSP ，用RA8P1 MCU 驱动 ST7796U 屏幕显示彩条，使用 MIPI 接口，分辨率为 222RGB x 480。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/st7796u_lcd_mipi_cpk_ra8p1_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
...
[ST7796U MIPI接口LCD样例工程使用说明](st7796u_lcd_mipi_cpk_ra8p1_ep_readme.adoc)
