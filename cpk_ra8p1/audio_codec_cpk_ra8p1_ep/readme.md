...
- 该示例工程演示了基于瑞萨 FSP ，用 RA8P1 MCU 上驱动 ES8311 I2S接口的音频芯片进行录音和音频播放。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/audio_codec_cpk_ra8p1_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
...
[audio_codec 测试工程使用说明](audio_codec_cpk_ra8p1_ep_readme.adoc)
