...
- 该示例工程演示了基于瑞萨 FSP ，用 RA8P1 MCU 驱动一个 MIPI CSI 接口的 OV5640 摄像头。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/ov5640_mipi_cpk_ra8p1_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
- 
### 支持的开发板 / 开发套件 / 演示板：
...
- 1个 OV5640 摄像头（市售的24Pin FPC接口摄像头即可）
...
[camera_mipi 测试工程使用说明](ov5640_mipi_cpk_ra8p1_ep_readme.adoc)
