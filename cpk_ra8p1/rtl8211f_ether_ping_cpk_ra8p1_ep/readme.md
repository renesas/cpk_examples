**该示例工程由 李昌壕 提供，2026年7月28日**

### 工程概述

- 该示例工程演示了基于瑞萨 FSP ，在 RA8P1 MCU 上使用以太网 PHY RTL8211F 接入网络，协商速度 100Mbps。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/rtl8211f_ether_ping_cpk_ra8p1_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
...
[RTL8211F PHY连接测试工程使用说明](rtl8211f_ether_ping_cpk_ra8p1_ep_readme.adoc)
