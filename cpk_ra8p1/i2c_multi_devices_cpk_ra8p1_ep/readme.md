**该示例工程由 李昌壕 提供，2026年8月18日**

### 工程概述

- 该示例工程演示了基于瑞萨 FSP ，在 RA8P1 MCU CPU0 （Cortex-M85）上使用 FSP 的 rm_comms_i2c stack，驱动在同一条总线上的多个 I2C 设备。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/i2c_multi_devices_cpk_ra8p1_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
...
[i2c_multi_device 测试工程使用说明](i2c_multi_devices_cpk_ra8p1_ep_readme.adoc)
