**该示例工程由 李昌壕 提供，2026年7月23日**

### 工程概述

- 该示例工程演示了基于瑞萨 FSP ，在 RA8P1 MCU上使用 PDM 立体声麦克风录音，然后使用 ES8311 进行播放。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/microphone_pdm_cpk_ra8p1_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
...
[PDM麦克风测试工程使用说明](microphone_pdm_cpk_ra8p1_ep_readme.adoc)
