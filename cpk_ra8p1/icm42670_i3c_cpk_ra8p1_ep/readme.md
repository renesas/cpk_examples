**该示例工程由 李昌壕 提供，2026年7月27日**

### 工程概述

- 该示例工程演示了基于瑞萨 FSP ，在 RA8P1 MCU CPU0 （Cortex-M85）上使用 I3C 驱动 ICM42670 六轴传感器。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/icm42670_i3c_cpk_ra8p1_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
...
[icm42670 测试工程使用说明](icm42670_i3c_cpk_ra8p1_ep_readme.adoc)
