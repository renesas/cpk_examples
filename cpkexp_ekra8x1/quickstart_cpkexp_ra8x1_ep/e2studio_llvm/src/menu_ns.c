...
#define SUB_OPTIONS              "\r\n查看下列网址获得关于开发套件信息、RA 系列 MCU 信息、下载工具和文档" \
                                 "\r\n"                                                                     \
                                 "\r\n a) RA8D1 资源:                renesas.com/ra/ek-ra8d1 "               \
                                 "\r\n b) RA 套件信息:               renesas.com/ra/kits"                    \
                                 "\r\n c) RA 产品信息:               renesas.com/ra"                         \
                                 "\r\n d) RA 产品支持论坛:           renesas.com/ra/forum"                   \
                                 "\r\n e) Renesas 支持:              renesas.com/support"                    \
