...
#define CAM_SCREEN              (5)
#define LED_SCREEN              (6)
#define DEMO_MODE_WEATHER_SCREEN          (7)
#define DEMO_MODE_AI_FACE_RECONITION      (8)
#define DEMO_MODE_AI_OBJECT_RECONITION    (9)
#define DEMO_MODE_CURRENCY_SCREEN         (10)
#define DEMO_MODE_TIMEZONE_SCREEN         (11)
 ...
 * Description  : Do nothing because SHOW_MODE undefined
