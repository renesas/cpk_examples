## 1.参考例程概述
该示例项目演示了基于瑞萨 FSP 的瑞萨 RA MCU 上 ADC16H: continues scan mode 驱动程序的基本功能。
...
#### 1.2.2 ADC 属性配置 ADC0 SAR continues scan mode，ADCCLK, DIV/2.
...
### 1.3 ADC 测试，具体操作
#### 1.3.1 ADC clock ：60MHZ,ADC channel 5, SAR mode, 12bit continues scan mode。
...
可以看到ADC total cycle count:  1667053，则ADC单次转换时间为0.1667us.
### 1.5 Release 模式测试
...
ADC 总周期数: 1666664， 则ADC单次转换时间为0.1666664us.
## 2. 支持的电路板：
CPKNET-RA8T2
## 3. 硬件要求：
