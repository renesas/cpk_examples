**该示例工程由 瑞萨电子-冉庆领 提供，2026年8月27日**

### 工程概述

- 该示例工程演示了基于瑞萨FSP的瑞萨RA MCU上 ADC16H（ADC_B）连续扫描驱动程序的基本功能。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/adc_continues_scan_cpknet_ra8t2_ep_rafsp6.5.0.zip)，其中包含了文档和代码。
...
[adc_continues_scan_cpknet_ra8t2_ep_readme](adc_continues_scan_cpknet_ra8t2_ep_readme.md)
