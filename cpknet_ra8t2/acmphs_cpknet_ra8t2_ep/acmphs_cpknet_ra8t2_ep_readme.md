...
![alt text](images/acmphs0.jpg)
#### 1.2.1 r_acmphs 属性配置.
![alt text](images/acmphs1.jpg)

### 1.3 添加DAC外设：Stack中添加“Analog - DAC(r_dac_b) ”.
![alt text](images/dac0.jpg)
#### 1.3.1 r_acmphs 属性配置.
![alt text](images/dac1.jpg)

### 1.4 Debug 模式测试
#### 1.4.1 工程切换为debug模式，编译工程。
![alt text](<images/debug mode.jpg>)
#### 1.4.2 查看map文件，搜索_SEGGER_RTT 地址，重新编译后，该地址可能会改变。
![alt text](images/RTT.jpg)
#### 1.4.3 debug时，打开J-Link RTT Viewer 输入_SEGGER_RTT 地址
![alt text](images/RTT1.jpg)
