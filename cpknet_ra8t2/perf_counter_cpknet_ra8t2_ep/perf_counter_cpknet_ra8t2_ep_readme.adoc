...
样例程序包含三个目录，对应FSP 6.4.0可以支持的三种编译器和对应的集成开发环境
...
| LLVM (ATfE) 21.1.1   | -O3 -flto |  #4254#    | 2598.16 | 4.33  
| GCC 13.2.1.arm-13-7  | -O3       | 8984    | 2944.32 | 4.91  
| Arm Compiler 6.23  | -Omax --lto | 9066    | 3771.63 | #6.29#  
|====
...
[%collapsible]
====
image::Snipaste_2026-08-17_11-04-32.png[width=640, height=480]
====

.展开查看perf_counter_gcc_release.hex 运行结果
[%collapsible]
====
image::Snipaste_2026-08-17_10-31-50.png[width=640, height=480]
====

.展开查看perf_counter_keil.hex 运行结果
[%collapsible]
====
image::Snipaste_2026-08-17_10-49-21.png[width=640, height=480]
====
...
|=====
| 编译器 | 优化选项            | 代码大小  | 测试成绩        | Coremark/MHz
.7+.^| LLVM 21.1.1   | -O0             | 8168  | 630.8402 | 1.05    
        | -O1             | 6616  | 2469.974374 | 4.12    
        | -O2             | 8448  | 2498.906728 | 4.16    
        | -O3             | 8880  | 2539.601917 | 4.23    
        | -O3 -flto       | #4254#  | 2598.161801 | #4.33#    
        | -Os             | 5276  | 2503.912363 | 4.17    
        | -Oz             | #4130#  | 2176.219363 | 3.63    
.7+.^| GCC 13.2.1   | -O0             | 8816  | 578.285384  | 0.96    
        | -O1             | 5200  | 2200.099004 | 3.67    
        | -O2             | 5992  | 2807.017544 | 4.68    
        | -O3             | 8984  | 2944.207272 | #4.91#    
        | -Os             | #4272#  | 2176.693059  | 3.63    
        | -Ofast          | 8984  | 2944.207272 | #4.91#    
        | -Oz             | 4272  | 2172.968275 | 3.62    
.8+.^| AC 6.23   | -O0             | 8120  | 637.308011 | 1.06    
        | -O1             | 6536  | 2435.460302 | 4.06    
        | -O2             | 10040 | 2627.948229 | 4.38    
        | -O3             | 10144 | 3362.898819 | 5.60    
        | -Ofast          | 10680 | 3362.898819 | 5.60    
        | -Os             | 5308  | 2451.055486 | 4.09    
        | -Oz             | #4284#  | 2219.140083 | 3.70    
        | -Omax --lto     | 9066  | 3771.627929  | #6.29#    
|=====
