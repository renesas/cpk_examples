...
调试完成后，修改优化选项为项目所需的值（例如使用-Omax --lto），参考 xref:perf_counter_cpknet_ra8t2_ep_readme.adoc#修改编译优化选项[修改编译优化选项] 
...
[source,c,subs="verbatim,attributes"]
----
_LANGUAGE=0x0804,__PERFC_USE_PMU_PORTING__=1,__PERFC_CFG_DISABLE_DEFAULT_SYSTICK_PORTING__=1,__CODE_AREA=CODE_ITCM,__DATA_AREA=DATA_DTCM,CONSOLE_CFG_USE_UART=1
----
