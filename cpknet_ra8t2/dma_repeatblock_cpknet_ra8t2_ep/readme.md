**该示例工程由 瑞萨电子-冉庆领 提供，2026年9月1日**

### 工程概述

- 该示例工程演示了基于瑞萨FSP的瑞萨RA MCU上 DMAC 驱动程序的基本功能-重复模式块传输。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/dma_repeatblock_cpknet_ra8t2_ep_rafsp6.5.0.zip)，其中包含了文档和代码。
...
[dma_repeatblock_cpknet_ra8t2_ep_readme](dma_repeatblock_cpknet_ra8t2_ep_readme.md)
