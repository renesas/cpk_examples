## 1.参考例程概述
该示例项目演示了基于瑞萨 FSP 的瑞萨 RA MCU 上 DAC12 驱动程序的基本功能。

### 1.1 创建新工程
如需了解工程的详细创建及配置流程，请参考工程：perf_counter_cpknet_ra8t2_ep

### 1.2 Stack中添加“DAC Driver on r_dac_b”.
![alt text](images/dac1.png)y
#### 1.2.1 dac 引脚配置.
![alt text](<images/dac pin.png>)
#### 1.2.2 dac 属性配置,选择DAC1.
![alt text](images/dac2.png)
