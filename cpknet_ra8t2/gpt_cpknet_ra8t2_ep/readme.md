...
- 该示例工程演示了基于瑞萨FSP的瑞萨RA MCU上GPT驱动程序的基本功能。
  - 测试了GPT的Periodic, PWM 和 one-shot 三种模式。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/gpt_cpknet_ra8t2_ep_rafsp6.5.0.zip)，其中包含了文档和代码。
...
[gpt_cpknet_ra8t2_ep_readme](gpt_cpknet_ra8t2_ep_readme.md)
