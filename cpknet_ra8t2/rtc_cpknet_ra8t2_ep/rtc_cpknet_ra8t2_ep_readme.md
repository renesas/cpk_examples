## 1.参考例程概述
该示例项目演示了基于瑞萨 FSP 的瑞萨 RA MCU 上 RTC 驱动程序的基本功能。

### 1.1 创建新工程
如需了解工程的详细创建及配置流程，请参考工程：perf_counter_cpknet_ra8t2_ep

### 1.2 Stack中添加“Timers-> Realtime Clock(r_rtc).
![alt text](images/rtc0.png)
#### 1.2.2 rtc 属性配置.
![alt text](images/rtc1.png)

### 1.3 rtc 测试，具体操作
#### 1.3.1 初始化RTC为指定的初始时间（2026-02-12 10:00:00） 
#### 1.3.2 1秒更新打印一次时间
