## 1.参考例程概述
该示例项目演示了基于瑞萨 FSP 的瑞萨 RA MCU 上 AGT 驱动程序的基本功能。
  分别测试了AGT的Periodic, one-shot 模式。
### 1.1 创建新工程
如需了解工程的详细创建及配置流程，请参考工程：perf_counter_cpknet_ra8t2_ep

### 1.2 Stack中添加两个“Timers on r_agt”.
![alt text](images/agt0.png)
#### 1.2.1 apt channel 0, 设置one-shot模式.
#### 1.2.2 apt channel 1, 设置periodic模式.
