**该示例工程由 李昌壕 提供，2026年8月17日**

### 工程概述

- 该示例工程基于瑞萨FSP， 演示了在RA8T2 MCU上，将代码与数据放在不同内存段时对性能的影响。
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/memconfig_benchmark_cpknet_ra8t2_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
...
[memconfig_benchmark_cpknet_ra8t2_ep_readme](memconfig_benchmark_cpknet_ra8t2_ep_readme.adoc) 
