## 1.参考例程概述
该示例项目演示了基于瑞萨 FSP 的瑞萨 RA MCU 上  DMAC block mode 驱动程序的基本功能。

### 1.1 创建新工程
如需了解工程的详细创建及配置流程，请参考工程：perf_counter_cpknet_ra8t2_ep

### 1.2 Stack中添加“Transfer on r_dmac”.
![alt text](images/dma0.png)
#### 1.2.1 dma 属性配置.
![alt text](images/dma.png)

### 1.3 dmc 测试，具体操作
    DMA BLOCK mode example: 3 source blocks -> 1 destination area.
    Configuration according to Figure 17.4 in RA8T2 Manual.
    Set DMA0 to BLOCK mode. Destination is specified as the Block Area.
...
![alt text](<images/debug result.jpg>)
...
![alt text](<images/Release putty.jpg>)
