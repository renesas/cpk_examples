...
- 该示例工程演示了基于瑞萨 FSP ，在 RA8T2 MCU CPU0 （Cortex-M85）上将 C stdio 重定向到 USB FS PCDC。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/sbfs_pcdc_console_cokcor_ra8t2_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
...
- 通信上位机通过 USB Type-C 线连接 CPKCOR-RA8T2 板上的 USB-FS 端口 JUSB
...
[usb_fs_pcdc_console 测试工程使用说明](usbfs_pcdc_console_cokcor_ra8t2_ep_readme.adoc)
