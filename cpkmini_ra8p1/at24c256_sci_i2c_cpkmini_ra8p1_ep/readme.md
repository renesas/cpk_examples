...
- 该示例工程演示了基于瑞萨 FSP ，在RA8P1 MCU 上使用 r_sci_i2c 驱动 EEPROM，型号为 AT24C256。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/at24c256_sci_i2c_cpkmini_ra8p1_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
...
[at24c256_sci_i2c 工程使用说明](at24c256_sci_i2c_cpkmini_ra8p1_ep_readme.adoc)
