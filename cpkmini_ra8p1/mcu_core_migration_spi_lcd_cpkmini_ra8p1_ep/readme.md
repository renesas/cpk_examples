**该示例工程由 李昌壕 提供，2026年8月21日**

### 工程概述

- 该示例工程基于瑞萨FSP， 以SPI LCD驱动程序为例，演示了在RA8P1 MCU上，将原运行在 CPU0 上的代码迁移至 CPU1 上运行。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/mcu_core_migration_spi_lcd_cpkmini_ra8p1_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
...
- 样例程序的主要运行参数： CPU0 - 1GHz, CPU1 - 250MHz, NPU - 不使用，ICLK 250MHz
...
[应用代码在双核CPU之间进行迁移的说明](mcu_core_migration_spi_lcd_cpkmini_ra8p1_ep_read.adoc) 
