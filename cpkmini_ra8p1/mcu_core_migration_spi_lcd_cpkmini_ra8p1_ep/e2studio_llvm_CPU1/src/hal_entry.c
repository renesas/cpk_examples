...
void hal_entry(void)
{
    ...
    LCD_PortDrawBitmap(&s_lcd, 0, 0, 222, 480, (const uint8_t *)g_picture_222x480_01.pixel_data);
    while (1) {
    	for (i = 0; i < 5; i++) {
    	...
    	LCD_PortDrawBitmap(&s_lcd, 0, 0, 222, 480, (const uint8_t *)g_picture_222x480_02.pixel_data);
