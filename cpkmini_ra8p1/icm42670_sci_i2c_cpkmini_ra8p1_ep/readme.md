...
- 该示例工程演示了基于瑞萨 FSP ，在 RA8P1 MCU 上使用 I2C(r_sci_i2c) 驱动 ICM42670 六轴传感器。
  - r_sci_i2c 是 FSP 基于 SCI 外设实现的 I2C 主从控制器，它可以作为 rm_comms_i2c 的底层操作接口。瑞萨也提供使用 rm_comms_i2c 的例程：[RA8P1 使用 I2C(rm_comms_i2c) 驱动 ICM42670](../ep_icm42670_comms_i2c/readme.md) 
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/icm42670_sci_i2c_cpkmini_ra8p1_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
...
[icm42670_sci_i2c 测试工程使用说明](icm42670_sci_i2c_cpkmini_ra8p1_ep_readme.adoc) 
