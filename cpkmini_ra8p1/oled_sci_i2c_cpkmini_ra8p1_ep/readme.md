**该示例工程由 李昌壕 提供，2026年8月6日**

### 工程概述

- 该示例工程演示了基于瑞萨 FSP ，在RA8P1 MCU 上使用 r_sci_i2c 驱动 OLED 屏幕模块，分辨率 128x64。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/oled_sci_i2c_cpkmini_ra8p1_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
...
[oled 工程使用说明](oled_sci_i2c_cpkmini_ra8p1_ep_readme.adoc)
