...
CPKMINI-RA8P1的硬件版本和勘误表：

* * CPKHMI-RA8P1 核心板目前只有 v1.2和 v1.1 两个版本的硬件有量产，link:../cpkhmi_ra8p1/docs/00_hw_revisions.adoc[版本信息和勘误链接]
* CPKEXP-MINI8x2 扩展板目前只有 v1.0 版量产，暂无勘误信息
