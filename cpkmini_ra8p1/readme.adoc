...
. link:../cpkmini_ra8p1/at24c256_soft_i2c_cpkmini_ra8p1_ep/[RA8P1使用软件模拟i2c 驱动 EEPROM] - link:../cpkmini_ra8p1/_ep_archive/at24c256_soft_i2c_cpkmini_ra8p1_ep_rafsp6.4.0.zip[下载ZIP包]
