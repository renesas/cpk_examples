...
- 该示例工程演示了基于瑞萨 FSP ，用RA8P1 MCU驱动板载的 RGB 转 HDMI 芯片 TFP410，在一个HDMI显示器上显示彩条，RA8P1上使用 32位 SDRAM 和 RGB 接口。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/hdmi_rgb_cpkhmi_ra8p1_ek8x2_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
- 
### 支持的开发板 / 演示板：

- CPKHMI-RA8P1 核心板 + CPKEXP-EK8x2 扩展板 组合
  
### 硬件要求：

- 1块 Renesas RA8P1 开发板：CPKHMI-RA8P1
- 1块 Renesas RA8x2 扩展板：CPKEXP-EK8x2
...
[lcd_hdmi工程使用说明](hdmi_rgb_cpkhmi_ra8p1_ek8x2_ep_readme.adoc)
