...
- 该示例工程演示了基于瑞萨 FSP ，用RA8P1 MCU 驱动 ILI9881C 屏幕显示彩条，使用 MIPI 接口。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/ili9881c_lcd_mipi_cpkcor_ra8p1_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
- 
### 支持的开发板 / 开发套件 / 演示板：
...
[lcd_ili9881c_mipi工程使用说明](ili9881c_lcd_mipi_cpkcor_ra8p1_ep_readme.adoc)
