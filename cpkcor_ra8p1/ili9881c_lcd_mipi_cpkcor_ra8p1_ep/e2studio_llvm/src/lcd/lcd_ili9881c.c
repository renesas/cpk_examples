...
#define ILI9881C_GLCDC_INSTANCE     g_lcdc_ili9881c
#define ILI9881C_GLCDC_CFG			UTIL_CONCAT(ILI9881C_GLCDC_INSTANCE, _cfg)
#define ILI9881C_GLCDC_CALLBACK		GLCDC_Callback
#define ILI9881C_MIPI_INSTANCE      g_mipi_dsi_ili9881c
...
uint32_t LCD_PortInit(LCD_Device *device)
{
    ...
    memset(ILI9881C_GLCDC_CFG.input[0].p_base, 0x00, DISPLAY_BUFFER_STRIDE_BYTES_INPUT0 * DISPLAY_VSIZE_INPUT0 * 2);
