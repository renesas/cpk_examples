...
#define FUSB303B_EN_PIN			BSP_IO_PORT_06_PIN_15
#endif

#ifndef __FUSB303B_DEBUG
#define __FUSB303B_DEBUG 1
#endif

#define FUSB303B_Read(addr, data, length)	IIC_ReadMemory(FUSB303B_ADDR, addr, 8, data, length)
#define FUSB303B_Write(data, length)		IIC_Write(FUSB303B_ADDR, data, length)
