**该示例工程由 李昌壕 提供，2026年9月23日**

### 工程概述

- 该示例工程演示了基于瑞萨 FSP ，在 RA8P1 MCU 上对 MicroSD 卡进行无文件系统的基本读写。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/microsd_basic_rw_cpkcor_ra8p1_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
...
[MicroSD卡基本读写功能测试工程使用说明](microsd_basic_rw_cpkcor_ra8p1_ep_readme.adoc)
