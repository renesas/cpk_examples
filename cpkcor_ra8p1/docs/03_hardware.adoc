...
|====
| 芯片型号          | 工作温度（结温）          | CPU0 （CM85） | CPU1（CM33） | 系统时钟（ICLK） | NPU时钟
| R7xA8P1xx #L# xxx | RA8P1 0℃~95℃    | 1GHz        | 250MHz     | 250MHz     | 500MHz
| R7xA8P1xx #D# xxx | RA8P1 -40℃~105℃ | 800MHz      | 200MHz     | 200MHz     | 400MHz
|====

{coreboardmcu} MCU主要针对边缘AI计算等对性能有较高要求的应用场景。

#{coreboardname}的BSP缺省设置为：CM85运行于1GHz。#
