...
#define CONSOLE_CFG_USB_INSTANCE	g_usbhs_pcdc
#define CONSOLE_CFG_USB_CALLBACK	USB_PCDC_Callback
...
#if CONSOLE_CFG_USE_RTT || CONSOLE_CFG_USE_UART || CONSOLE_CFG_USE_USB || CONSOLE_CFG_USE_LCD || CONSOLE_CFG_USE_RPMSG
