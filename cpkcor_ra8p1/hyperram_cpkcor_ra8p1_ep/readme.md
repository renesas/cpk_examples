**该示例工程由 李昌壕 提供，2026年9月4日**

### 工程概述

- 该示例工程演示了基于瑞萨 FSP ，在RA8P1 MCU 上驱动 HyperRAM。
...
- 如果您没有同步代码库及版本控制的需求，也可以[直接下载样例程序的ZIP压缩包](../_ep_archive/hyperram_cpkcor_ra8p1_ep_rafsp6.4.0.zip)，其中包含了文档和代码。
...
[HyperRAM工程使用说明](hyperram_cpkcor_ra8p1_ep_readme.adoc)
